...
public class Battery extends CarComponent
{
    ...
    public boolean generateElectricityInVolts()
    {
        if(getIsWorking())
        {
            ...
            {
                System.out.println("The battery has been damaged and does not electricity in volts.");
                return false;
            }
            System.out.println("The battery generates electricity in volts.");
            return true;
        }
        else
            {
                System.out.println("The battery is not working and does not generate electricity in volts.");
                return false;
            }
    }
    ...
    public boolean poweredOn()
    {
        if(getIsWorking())
        {
            if(((int) (Math.random() * 100) + 1) > 85)
            {
                System.out.println("The battery has been damaged and cannot be powered on.");
                return false;
            }
            System.out.println("The battery is powered on.");
            return true;
        }
        else
            {
                System.out.println("The battery cannot be powered on.");
                return false;
            }
    }
